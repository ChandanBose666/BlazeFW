 ...
 * stringify     — converts BlazeNode children to a plain HTML string
 */
...
/**
 * Converts a BlazeNode tree into a flat HTML string.
 *
 ...
 *
 * BlazeElement (an `object` at the type layer) never appears at runtime
